...
| 编号 | 操作                                          | Eclipse                              | Idea                     |
| ---- | --------------------------------------------- | ------------------------------------ | ------------------------ |
| 1    | 优化导入的类                                  | Ctrl+Shift+O                         | Ctrl + Alt + O           |
| 2    | 重命名                                        | Alt+Shift+R                          | Shift+F6                 |
| 3    | 删除当前行                                    | Ctrl+D                               | Ctrl+X                   |
| 4    | 重写父类方法                                  | Alt+/                                | Ctrl+O                   |
| 5    | 上下移动代码块                                | Alt+↓/↑                              | Alt+Shift+↓/↑            |
| 6    | 快速返回                                      | Alt+Shift+L                          | Ctrl+Alt+V               |
| 7    | 复制当前行到下一行                            | Ctrl+Alt+↑/↓                         | Ctrl+D                   |
| 8    | 上面添加一行空白                              | Ctrl+Shift+Enter                     |                          |
| 9    | 执行到下一个断点                              | F8                                   | F9                       |
| 10   | 大小写转化                                    | Ctrl+Shift+x 小写  Ctrl+Shift+y 大写 | Ctrl+Shift+U             |
| 11   | 查找下一个                                    | Ctrl+K                               | Ctrl+F3                  |
| 12   | 查找上一个                                    | Ctrl+Shift+K                         | Shift+F3                 |
| 13   | 查看类的所有方法                              | OutLine 按钮/Ctrl+O                  | Alt+7/左下角Structure    |
| 14   | 快速输出                                      | sysout                               | sout                     |
| 15   | get/set/重写equals()、hashcode()\toString()等 | Alt + Shift + s                      | Alt + Insert             |
| 16   | 查看类的继承结构                              | Ctrl + T                             | Ctrl + Alt + B/ Ctrl + H |
| 17   | 格式化代码                                    |                                      | Ctrl+Alt+L               |
| 18   | 实现接口的类                                  |                                      | Alt + 回车               |
| 19   | 查看父类的子类                                |                                      | Ctrl + H                 |
| 20   | 方法参数提示                                  |                                      | Ctrl + P                 |
| 21   | 按名字搜索类                                  | ctrl+shift+H                         | Ctrl+N                   |
| 22   | 对代码块做事                                  | alt+shift+z                          | ctrl + alt + T           |
| 23   | 查看接口的实现类                              |                                      | ctrl + alt + 鼠标左键    |
|      |                                               |                                      |                          |
|      |                                               |                                      |                          |
|      |                                               |                                      |                          |
|      |                                               |                                      |                          |
...
```shell
https://zhuanlan.zhihu.com/p/61690346  知乎IDEA 快捷键
```
...
Alt+/	内容辅助
Alt+↓	当前行和下面一行交互位置
Ctrl+Alt+↓	复制当前行到下一行 (inter核显 先改快捷键再禁用。只是禁用也会冲突)
Shift+Enter	在当前行的下一行插入空行
Ctrl+/	注释当前行,再按则取消注释
Ctrl+K	参照选中的Word快速定位到下一个  ##	F3
Ctrl+Shift+K	参照选中的Word快速定位到上一个	##	Shift+F3
Ctrl+Shift+T	搜索类
Alt+←	前一个编辑的页面
Alt+→	下一个编辑的页面
...
Ctrl+I，实现方法
Ctrl+Shift+U，  ##  大小写转化   Ctrl+Shift+x 小写  Ctrl+Shift+y 大写
Ctrl+Y，删除当前行  ## Ctrl+D
Shift+Enter，  ## 向下插入新行  Ctrl+Enter
Alt+Enter，  ## 向上插入新行    Ctrl+Shift+Enter
Ctrl+F6   ## 批量修改   
...
Ctrl+Shift+F10，运行
Ctrl+Shift+F8，查看断点
F8，步过 ## 单步调试，不进入函数内部   F6
F7，步入 ## 单步调试，进入函数内部    F5
Shift+F7，智能步入 ## 选择要进入的函数
Shift+F8，步出 ##  跳出函数
Alt+Shift+F8，强制步过
Alt+Shift+F7，强制步入
Alt+F9，运行至光标处 
Ctrl+Alt+F9，强制运行至光标处
F9，恢复程序 ## 继续执行，进入下一个断点或执行完程序
Alt+F10，定位到断点
Ctrl+F8，切换行断点
Ctrl+F9，生成项目
Alt+1，项目
...
里有许多值得一提的小窍门，如果能熟练的将它们应用于实际开发过程中，相信它会大大节省你的开发时间，而且随之而来的还会有那么一点点成就感：） Try
